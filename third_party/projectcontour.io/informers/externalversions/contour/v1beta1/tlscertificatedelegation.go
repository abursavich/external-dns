...
import (
	...
	contourv1beta1 "sigs.k8s.io/external-dns/third_party/projectcontour.io/apis/contour/v1beta1"
	versioned "sigs.k8s.io/external-dns/third_party/projectcontour.io/clientset/versioned"
	internalinterfaces "sigs.k8s.io/external-dns/third_party/projectcontour.io/informers/externalversions/internalinterfaces"
	v1beta1 "sigs.k8s.io/external-dns/third_party/projectcontour.io/listers/contour/v1beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ContourV1beta1().TLSCertificateDelegations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ContourV1beta1().TLSCertificateDelegations(namespace).Watch(context.TODO(), options)
			},
		},

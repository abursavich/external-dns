...
import (
	...
	projectcontourv1 "sigs.k8s.io/external-dns/third_party/projectcontour.io/apis/projectcontour/v1"
	...
	v1 "sigs.k8s.io/external-dns/third_party/projectcontour.io/listers/projectcontour/v1"
)

...
import (
	...
	v1 "sigs.k8s.io/external-dns/third_party/solo.io/apis/gloo/v1"
	scheme "sigs.k8s.io/external-dns/third_party/solo.io/clientset/versioned/scheme"
)
...
func newProxies(c *GatewayV1Client, namespace string) *proxies {
	return &proxies{
		client: c.RESTClient(),
		ns:     namespace,
	}

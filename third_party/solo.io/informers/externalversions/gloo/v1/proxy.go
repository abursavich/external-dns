	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1().Proxies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1().Proxies(namespace).Watch(context.TODO(), options)
			},
		},
		&gloov1.Proxy{},
		resyncPeriod,
...
func (f *proxyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gloov1.Proxy{}, f.defaultInformer)
}
